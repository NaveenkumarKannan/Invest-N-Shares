...
public class CommodityPage extends AppCompatActivity {
    Timer myTimer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CommodityPagerAdapter adapter = new CommodityPagerAdapter(getSupportFragmentManager(),tabLayout.getTabCount());
    ...
    public void onBackPressed() {
        ...
        myTimer.cancel();
        myTimer.purge();
        Intent intent = new Intent(CommodityPage.this,MainActivity.class);
