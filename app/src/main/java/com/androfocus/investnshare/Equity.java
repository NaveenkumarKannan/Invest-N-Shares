...
public class Equity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) view.findViewById(R.id.lvEquity);
        equityAdapter = new EquityAdapter(getContext(), R.layout.equity_row_layout);
    ...
    public class BackgroundWorkerJson extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            //loading = ProgressDialog.show(getContext(), "Fetching EquityData...","Please Wait...",true,true);
        }
...
//            Log.e("Image JSON", json_string);
            if(json_string == null){
                ...
                try {
                    ...
                    String id = null, type1, type2, name, target1, target2, target3, buy, sell, note, date, image, time,type3,type4;
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        EquityData equityData = new EquityData(type1, type2, name, target1, target2, target3, buy, sell, note, date, bitmap,time,type3,type4);
                        equityAdapter.add(equityData);
                    }
                    loading.dismiss();
                    if(id!=null){
